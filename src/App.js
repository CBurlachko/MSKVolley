...
import teamInfo from './MIX2022_Teams.json';
...
function App() {
    ...
    // TODO: Страница MatchDay - вёрстка и анимации целиком
    // TODO: Страница TeamPage - добавить инфо о команде, оформить блок со статистикой
    // TODO: Страница MixTeams - уменьшить размеры, прикинуть пагинацию
    // TODO: Страница MixTour - доделать вёрстку
    // TODO: Страница MixStats - пагинация с раскрытием
    ...
    <div className={styles.App}>
        <div className={styles.Header}>
            ...
            <div className={styles.NavBar}>
                <div className={styles.ButtonWrap}>
                    <button className={styles.Tables}>Турнир</button>
                    <div className={styles.DropDownContent}>
                        <Link to="/mix-tour">{'Микс'}</Link>
                    </div>
                </div>
                <div className={styles.ButtonWrap}>
                    <button className={'Teams'}>Команды</button>
                    <div className={styles.DropDownContent}>
                        <Link to="/mix-teams">{'Микс'}</Link>
                    </div>
                </div>
                <div className={styles.ButtonWrap}>
                    <button className={'Stats'}>Статистика</button>
                    <div className={styles.DropDownContent}>
                ...
                <div className={styles.ButtonWrap}>
                    <Link to="/documents">
                    <button className={'Documents'}>Документы</button>
                    </Link>
                </div>
            </div>
        </div>
        <div className={styles.Content}>
            <Routes>
                ...
                <Route path='/match-day' element={<MatchDayPage value={matchDay}/>} />
                <Route path='/team-page' element={<TeamPage teamInfo={teamPage}/>} />
